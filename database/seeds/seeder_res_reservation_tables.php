...
class seeder_res_reservation_tables extends Seeder
{
    ...
    private function getData() {
        ...
        return [
            ...
            $this->getRow(9, 1, 1, "2016-08-25", "16:00:00", "1:15:00", 2),
            $this->getRow(10, 1, 2, "2016-08-25", "16:00:00", "1:15:00", 2),
            
            $this->getRow(11, 1, 5, "2016-08-25", "17:00:00", "1:15:00", 2),
            $this->getRow(12, 1, 6, "2016-08-25", "17:00:00", "1:15:00", 2),
        ];
    }
